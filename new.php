...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage" style="font-size:20px; color:#C94B4B";><span class="glyphicon glyphicon-pencil" style="color:#000"></span>ASSIGN!!</a>
    </div>
...
<div class="jumbotron text-center">
  <h1 id="h01">ASSIGN!!</h1>
  <p1>Online Assignment Submission Portal</p1>
  <div>
  <br><br>
...
<div class="container-fluid bg-grey" id="ourvalues">
  <div class="row">
    ...
    <div class="col-sm-8">
      <h2>OUR VALUES</h2>
      <br>
      <h4><strong>MISSION:</strong> Save Paper, Register with <strong>ASSIGN!!</strong></h4>
...
<div class="container-fluid bg-grey" id="contact">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-user"></span> Ishaan Pahwa</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 9575299330</p>
      <p><span class="glyphicon glyphicon-envelope"></span> pahwaishaan23@outlook.com</p> 
    </div>
